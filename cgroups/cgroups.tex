...
\item \emph{Red Hat rules}---discuss all four Red Hat rules and add refs to spec (quotations) (\textsc{Dropped});
\end{itemize}
...
The first way is where all the subsystem change together. We describe what one among many changes might look like:
