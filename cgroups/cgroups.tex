...
Note that this version assumes that each hierarchy must be associated with at least one subsystem.
This assumption is incorrect and needs removing.

Note to readers who are not familiar with the Z notation: you should be able to read the English, ignore the Z, and get some benefit from the document.
...
The specification implies that this is a no-op: the resources used are unchanging. It remains to be seen if this is the case,
